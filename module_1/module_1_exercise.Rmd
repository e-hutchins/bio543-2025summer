...
```{r}
getwd()
data <- read.csv("module_1/module_1_data.csv", header = TRUE, sep = ",") #Load the data. The header argument indicates that the first row of the file is a header with the variable names. The sep argument indicates that the file is separated by commas
